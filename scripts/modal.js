...
(function (ProcessOut_1) {
    var ProcessOut = (function () {
        ...
        ProcessOut.prototype.setTemplate = function (name, value) {
        ...
        ProcessOut.prototype.resetTemplate = function (name, value) {
            if (this.availableTemplates.indexOf(name) <= -1)
                throw new Error("The template " + name + " is not supported.");
        ...
        ProcessOut.prototype.findRecurringInvoice = function (uid, success, error) {
            var invoice = new ProcessOut_1.Subscription(this);
            invoice.find(uid, success, error);
        };
        return ProcessOut;
    }());
...
(function (ProcessOut) {
    var Subscription = (function () {
        function Subscription(instance) {
            this.instance = instance;
        }
        Subscription.prototype.find = function (uid, success, error) {
            var t = this;
            t.uid = uid;
            t.instance.apiRequest("get", "/recurring-invoices/" + uid, {}, function (data, code, jqxhr) {
                ...
                t.instance.apiRequest("get", "/recurring-invoices/" + uid + "/gateways", {}, function (data, code, jqxhr) {
                    t.gatewaysList = [];
                    for (var i = 0; i < data.gateways.length; i++) {
                        t.gatewaysList[i] = ProcessOut.Gateways.Handler.buildGateway(t.instance, data.gateways[i], "/recurring-invoices/" + uid, ProcessOut.Flow.Subscription);
                    }
                    success(t);
                }, function () {
                    error({
        ...
        Subscription.prototype.gateways = function () {
            return this.gatewaysList;
        };
        return Subscription;
    }());
    ProcessOut.Subscription = Subscription;
})(ProcessOut || (ProcessOut = {}));
var ProcessOut;
(function (ProcessOut) {
    var AuthorizationRequest = (function () {
        function AuthorizationRequest(instance) {
            this.instance = instance;
        }
        AuthorizationRequest.prototype.find = function (uid, success, error) {
            var t = this;
            t.uid = uid;
            t.instance.apiRequest("get", "/authorizations/" + uid, {}, function (data, code, jqxhr) {
                ...
                t.instance.apiRequest("get", "/authorizations/" + uid + "/gateways", {}, function (data, code, jqxhr) {
                    t.gatewaysList = [];
                    for (var i = 0; i < data.gateways.length; i++) {
                        t.gatewaysList[i] = ProcessOut.Gateways.Handler.buildGateway(t.instance, data.gateways[i], "/authorizations/" + uid, ProcessOut.Flow.Tokenization);
                    }
                    success(t);
                }, function () {
                    error({
        ...
        AuthorizationRequest.prototype.gateways = function () {
            return this.gatewaysList;
        };
        return AuthorizationRequest;
    }());
    ProcessOut.AuthorizationRequest = AuthorizationRequest;
})(ProcessOut || (ProcessOut = {}));
var ProcessOut;
(function (ProcessOut) {
    (function (Flow) {
        ...
        var Gateway = (function () {
            ...
            Gateway.prototype.getEndpoint = function (async) {
                switch (this.flow) {
                    ...
                    case ProcessOut.Flow.Subscription:
                    case ProcessOut.Flow.Tokenization:
                        if (!async)
                            return this.resourceURL + ("/gateways/" + this.name);
                        else
