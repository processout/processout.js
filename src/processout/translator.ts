...
module ProcessOut {
    ...
    const errors: { [locale: string]: { [name: string]: string } } = {
        ...
        "pt": {
            ...
            "card.invalid-date, card.invalid-expiry-date": "A data de validade do cartão é inválida.",
            "card.invalid-month, card.invalid-expiry-month": "O mês de validade do cartão é inválido.",
            "card.invalid-year, card.invalid-expiry-year": "O ano de validade do cartão é inválido.",
