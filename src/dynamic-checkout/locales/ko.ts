module ProcessOut {
  export const ko = {
    ...
    "verification-success-message": "인증이 완료되었습니다.",
    "verification-cancelled-message": "인증이 취소되었습니다.",
    "verification-info-message": "인증을 처리하고 있습니다. 이 창을 닫으셔도 됩니다.",
    "verification-pending-message": "인증이 대기 중입니다.",
    "verification-error-generic-message": "카드를 인증할 수 없습니다.",
    "processing-verification-label": "인증 처리 중",
    "street1-label": "주소 1",
    "street2-label": "주소 2",
    "city-label": "시/군/구",
    "postcode-label": "우편번호",
